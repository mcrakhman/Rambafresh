//
//  RambafreshAnimatableView.swift
...
enum RambafreshAnimatableViewConstants {
    enum KeyPaths {
...
open class RambafreshAnimatableView: UIView, RambafreshAnimatableViewConforming {
    
    fileprivate let animationsFactory = RambafreshAnimationsFactory()
    fileprivate let sublayersFactory = RambafreshSublayersFactory()
    fileprivate let constants = RambafreshAnimatableViewConstants.self
