...
class RambafreshView: UIView {
    
    fileprivate let scrollView: UIScrollView
    fileprivate let customView: UIView
    fileprivate let animatable: RambafreshAnimatable
    fileprivate let handler: ActionHandler
    fileprivate let constants = RambafreshViewConstants.self
    fileprivate let animationEndDistanceOffset: CGFloat
    fileprivate let animationStartDistance: CGFloat
    fileprivate var privateState: RambafreshState = .triggered
    ...
    init(frame: CGRect, configuration: RambafreshViewConfiguration) {
    ...
    override func willMove(toSuperview newSuperview: UIView?) {
        ...
        if let scrollView = superview as? UIScrollView, newSuperview == nil {
            ...
            if scrollView.showsPullToRefresh && isObserving == true {
                ...
                scrollView.panGestureRecognizer.removeTarget(self, action: #selector(RambafreshView.gestureRecognizerUpdated(_:)))
            }
